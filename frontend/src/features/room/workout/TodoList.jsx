...
const ActiveIcon = () => {
  return (
    <span class="flex absolute -left-3 justify-center items-center w-5 h-5 bg-blue-200 rounded-full  dark:ring-gray-900 dark:bg-blue-900">
...
export const TodoList = () => {
  ...
  return (
    <ol className="relative border-l border-gray-200 dark:border-gray-700">
      {list.map((item, index) => (
        <li className={index === list.length - 1 ? "ml-5 pb-12" : "mb-10 ml-5"}>
