...
public enum CustomExceptionList {
    ...
    MEMBER_HISTORY_NOT_FOUND(HttpStatus.INTERNAL_SERVER_ERROR, "E013", "개인 운동 기록이 생성되지 않았습니다."),
    TEAM_HISTORY_NOT_FOUND(HttpStatus.INTERNAL_SERVER_ERROR, "E014", "팀 운동 기록이 생성되지 않았습니다.");
